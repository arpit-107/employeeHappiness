...
public class SurveyPageOne extends JFrame implements ActionListener{
    ...
    public void init() {
        ...
        lage.setText("I am pleased with the way my work is assigned to me");
