...
public class SurveyPageFour extends JFrame implements ActionListener{
    ...
    public void init() {
        ...
        lage.setText("I am pleased with the transparency management maintains");
